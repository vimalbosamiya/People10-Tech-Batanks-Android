...
class ParticipantsFragment (private val eventId : Int) : BaseFragment()  {
    ...
    private var participantsList : ArrayList<Guests> = arrayListOf()
            ...
            when (response.status) {
                ...
                Status.SUCCESS -> {
                   ...
                   //guestsList = event!!.guests
                    ...
                    invitationStatusRecyclerview.adapter = InvitationStatusListAdapter(participantsList, eventDetailViewModel, eventId)
                }
                Status.ERROR -> {
                    hideLoader()
