...
class DeclineFragment (private val eventId : Int) : BaseFragment()  {
    ...
    private var declinedList : ArrayList<Guests> = arrayListOf()
                ...
                Status.SUCCESS -> {
                    ...
                    for (item in event!!.guests!!){
                        ...
                        if (item.status == "DN"){
                            ...
                            declinedList.add(item)
                        }
                    }

                    //guestsList = event!!.guests

                    invitationStatusRecyclerview.adapter = InvitationStatusListAdapter(declinedList, eventDetailViewModel, eventId)
                }
                Status.ERROR -> {
                    hideLoader()
