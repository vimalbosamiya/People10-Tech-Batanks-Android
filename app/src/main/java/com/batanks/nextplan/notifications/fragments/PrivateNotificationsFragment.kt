        ...
        notificationsViewModel.responseLiveData.observe(viewLifecycleOwner, Observer{ response ->
            ...
            when(response.status){
                ...
                Status.SUCCESS -> {
                    ...
                    NotificationsViewModel.privatenotificationsList.clear()
                    ...
                    notificationsRecyclerView.adapter = NotificationsListAdapter(NotificationsViewModel.privatenotificationsList, notificationsViewModel)
