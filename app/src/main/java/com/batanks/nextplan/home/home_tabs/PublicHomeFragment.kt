...
class PublicHomeFragment : BaseFragment()/*, HomePlanPreviewAdapter.HomePlanPreviewAdapterListener*/ {
    ...
    private var publicEventList : ArrayList<GetEventListHome> = arrayListOf()
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
                ...
                Status.SUCCESS -> {
                    ...
                    for (item in eventList){
                        ...
                        if(item.private != true){
                            ...
                            if (!publicEventList.contains(item)){
                    ...
                    recyclerView?.adapter = HomePlanPreviewAdapter(true, publicEventList)
                }
                Status.ERROR -> {
                    hideLoader()
        ...
        //recyclerView?.adapter = HomePlanPreviewAdapter(HomePlanPreviewViewModel.publicEventList/*,this*/)
...
//            filteredEventList.clear()
    ...
    override fun setUserVisibleHint(isVisibleToUser: Boolean) {
        ...
        if (isVisibleToUser && isResumed()){
            ...
            println("Public visible text set to null")
        }
