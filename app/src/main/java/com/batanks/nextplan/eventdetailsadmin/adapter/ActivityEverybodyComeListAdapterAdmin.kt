...
class ActivityEverybodyComeListAdapterAdmin (val contactList: ArrayList<ActivityParticipant>, val context: Context) :
    RecyclerView.Adapter<ActivityEverybodyComeListAdapterAdmin.ViewHolder>() {
        ...
        override fun onBindViewHolder(holder: ViewHolder, position: Int) {
            ...
            holder.contactName.text = contactList?.get(position)?.username
